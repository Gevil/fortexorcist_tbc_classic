...
local function NewColorSwatch(parent)
  local obj = CreateFrame("Button",nil,parent, BackdropTemplateMixin and "BackdropTemplate");
  obj.parent = parent;
...
local function NewDropdownShowButton(parent,dropdown)
  local obj = CreateFrame("Frame",nil,parent,BackdropTemplateMixin and "BackdropTemplate");
  obj.parent = parent;
...
local function NewEditBox(parent)
  local obj = CreateFrame("EditBox",nil,parent,BackdropTemplateMixin and "BackdropTemplate");
  obj.parent = parent;
  obj:SetWidth(100);
  obj:SetHeight(14);
...
local function NewBackdropOption(parent,o,s,d)
  ...
  obj.button = CreateFrame("Frame",nil,objBackdropTemplateMixin and "BackdropTemplate");
  obj.button:SetWidth(140);
  obj.button:SetHeight(34);
  obj.button:SetPoint("LEFT",obj.text,"RIGHT",5,0);
  obj.button:EnableMouse(1);

  obj.overbutton = CreateFrame("Frame",nil,obj.button,BackdropTemplateMixin and "BackdropTemplate");
  ...
  obj.default:SetScript("OnClick",function(self)
	...
	--Mixin(obj.button, BackdropTemplateMixin);
...
local function NewOptionsFrame(parent)
  ...
  obj.frameheader = CreateFrame("Frame",nil,obj,BackdropTemplateMixin and "BackdropTemplate");
  ...
  obj.header = CreateFrame("Frame",nil,obj,BackdropTemplateMixin and "BackdropTemplate");
...
local function NewInfoOption(parent,o,s,d)
  local obj = CreateFrame("Frame",nil,parent,BackdropTemplateMixin and "BackdropTemplate"); -- dont use NewOption function for this one
  obj.o = o;
  obj.s = s or FW.Settings;
  obj.d = d or FW.Default;
  obj.parent = parent;
...
local function NewScrollFrame(parent)
  local obj = CreateFrame("ScrollFrame",nil,parent,BackdropTemplateMixin and "BackdropTemplate");
  obj.parent = parent;
  obj:SetWidth(560);
  obj:SetHeight(460);
  ...
  obj.scrollbar = CreateFrame("Slider", nil, obj, "UIPanelScrollBarTemplate" and BackdropTemplateMixin and "BackdropTemplate");
  ...
  obj.content = CreateFrame("Frame",nil,obj,BackdropTemplateMixin and "BackdropTemplate");
...
function FW:NewOptionsPanel()
  local obj = CreateFrame("Frame",nil,UIParent,BackdropTemplateMixin and "BackdropTemplate");
  OptionsPanel = obj;
  ...
  obj.close = CreateFrame("Button",nil,obj,BackdropTemplateMixin and "BackdropTemplate");
  ...
  do
    ...
    obj.SetBackdrop = function(self)
      ...
      -- dropdowns
	  --Mixin(texturedropdown, BackdropTemplateMixin);
	  --Mixin(fontdropdown, BackdropTemplateMixin);
	  --Mixin(backdropdropdown, BackdropTemplateMixin);
      ...
      if filterdropdown then
	    --Mixin(filterdropdown, BackdropTemplateMixin);
        filterdropdown:SetBackdrop(bgbackdrop);
      end
      if sounddropdown then
	    --Mixin(sounddropdown, BackdropTemplateMixin);
      ...
      for main_index, main_data in ipairs(FW_Options) do -- MAIN OPTION LEVEL
		...
		--Mixin(main_data.option, BackdropTemplateMixin);
    ...
    for main_index, main_data in ipairs(FW_Options) do -- MAIN OPTION LEVEL
      ...
      if tab_actions ~= nil then -- has tabs enabled!
        if not main_data.tabs then
          main_data.tabs = {};
          main_data.tabs_frame = CreateFrame("Frame",nil,self.scrollframe.content, BackdropTemplateMixin and "BackdropTemplate");
...
function FW:LocalizedData()
  ...
  local function FC_SetOptionsBackdrop()
    --Mixin(OptionsPanel, BackdropTemplateMixin);
